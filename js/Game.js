        ...
        displayRanks(){
          ...
          for (plr in allPlayers){
            ...
            if(allPlayers[plr].place === 1)
              text("1St : " +allPlayers[plr].name, 0 ,25 );
             
             else if(allPlayers[plr].place === 2) 
             text("2nd : " +allPlayers[plr].name, 0 ,30 );

             else if(allPlayers[plr].place === 3) 
             text("3rd : " +allPlayers[plr].name, 0 ,35 );

             else{
              text("Thanks for racing : " +allPlayers[plr].name, 0 ,40 );
